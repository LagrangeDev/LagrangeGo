...
type CommonElemImagePb struct {
	Field1 *CommonImage1 `protobuf:"bytes,1,opt"`
	Field2 *CommonImage2 `protobuf:"bytes,2,opt"`
	_      [0]func()
}

type CommonImage1 struct {
	Extra *CommonImageExtra `protobuf:"bytes,1,opt"`
	Url   *ImageUrl         `protobuf:"bytes,2,opt"`
	_     [0]func()
}

type CommonImage2 struct {
	DownloadInfo *ImageDownloadInfo `protobuf:"bytes,1,opt"`
	_            [0]func()
}

type CommonImageExtra struct {
	Info      *CommonImageInfo `protobuf:"bytes,1,opt"`
...
type ImageDownloadInfo struct {
	Info *ImageDownloadInfoField12 `protobuf:"bytes,12,opt"`
	_    [0]func()
}

type ImageDownloadInfoField12 struct {
	PathWithRkey string `protobuf:"bytes,30,opt"`
	_            [0]func()
}

type CommonImageInfo struct {
	Size     uint32 `protobuf:"varint,1,opt"`
	Md5      string `protobuf:"bytes,2,opt"`
	Sha1     string `protobuf:"bytes,3,opt"`
...
type ImageUrl struct {
	Path string `protobuf:"bytes,1,opt"`
	Host string `protobuf:"bytes,3,opt"`
	_    [0]func()
}
