...
var CURVE map[string]*EllipticCurve
...
func newEllipticCurve(P, A, B *big.Int, G *EllipticPoint, N, H, Size, PackSize *big.Int) *EllipticCurve {
	return &EllipticCurve{p: P, a: A, b: B, g: G, n: N, h: H, size: Size, packSize: PackSize}
}
...
func init() {
	...
	CURVE = map[string]*EllipticCurve{
		"secp192k1": newEllipticCurve(
			S192P,
			big.NewInt(0),
			big.NewInt(3),
			&EllipticPoint{
