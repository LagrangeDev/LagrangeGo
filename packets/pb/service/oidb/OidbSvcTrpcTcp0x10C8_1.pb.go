...
// source: pb/service/oidb/OidbSvcTrpcTcp0x10C8_1.proto
...
type OidbSvcTrpcTcp0X10C8_1 struct {
	Accept uint32                      `protobuf:"varint,1,opt"` // 2 for reject, 1 for accept, 3 for ignore
	Body   *OidbSvcTrpcTcp0X10C8_1Body `protobuf:"bytes,2,opt"`
	_      [0]func()
}

type OidbSvcTrpcTcp0X10C8_1Body struct {
